...
<head>
    ...
    <style>
        ...
        <?php include (dirname(__FILE__).'../../styles/resume.css')?>    
    </style>    
    ...
    <main class="container-page">
        <div id="container-resume">
            ...
            <div class="resume-body-container">
                <?php include (dirname(__FILE__).'../../components/previousEmployment.php')?>    
                <?php include (dirname(__FILE__).'../../components/skills.php')?>    
                <?php include (dirname(__FILE__).'../../components/education.php')?>    
            </div>
        </div>
    </main>
